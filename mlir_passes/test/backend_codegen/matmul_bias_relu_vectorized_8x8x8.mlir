...
// named distinctly (matmul_bias_relu_vectorized_<shape>) so the generic and
// vectorized objects can be linked into the same benchmark harness without
// symbol collisions. See mlir_passes/tools/compile_hir_matmul_bias_relu_aarch64.sh
// --variant vectorized.
//
// Shape: M=8, N=8, K=8.

func.func @matmul_bias_relu_vectorized_8x8x8(
    %lhs: tensor<8x8xf32>,
    %rhs: tensor<8x8xf32>,
