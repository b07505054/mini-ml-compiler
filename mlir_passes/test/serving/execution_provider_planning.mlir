...
//   3. Preferred filtered by paged KV -> kv_layout_constraint
...
// "coreml" is preferred but not paged-KV-compatible.
// "cuda" is in allowed_backends and is paged-KV-compatible.
...
// allowed_backends = ["coreml", "cpu"]: neither is paged-KV-compatible.
