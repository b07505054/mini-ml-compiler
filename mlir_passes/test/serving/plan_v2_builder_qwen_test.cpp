// CTest unit test for ExecutionPlanV2Builder with Qwen 2.5-0.5B model attrs.
//
// Architecture contract under test:
//   ExecutionPlanV2Builder is a COLLECTOR only.  It must not make decisions.
...
//   - Call ExecutionPlanV2Builder::build.
