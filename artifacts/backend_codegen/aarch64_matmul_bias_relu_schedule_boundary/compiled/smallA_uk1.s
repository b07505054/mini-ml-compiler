...
.LBB0_7:                                //   Parent Loop BB0_2 Depth=1
	...
	ldp	q22, q23, [x16]
	fmla	v23.4s, v0.4s, v24.s[0]
	fmla	v22.4s, v15.4s, v24.s[0]
	ldp	q31, q13, [x16, #64]
	fmla	v13.4s, v0.4s, v21.s[0]
	fmla	v31.4s, v15.4s, v21.s[0]
	ldp	q26, q8, [x16, #128]
	fmla	v8.4s, v0.4s, v20.s[0]
	fmla	v26.4s, v15.4s, v20.s[0]
	ldp	q28, q11, [x16, #192]
	fmla	v11.4s, v0.4s, v19.s[0]
	fmla	v28.4s, v15.4s, v19.s[0]
	ldp	q9, q14, [x16, #256]
	fmla	v14.4s, v0.4s, v18.s[0]
	fmla	v9.4s, v15.4s, v18.s[0]
	ldp	q27, q10, [x16, #320]
	fmla	v10.4s, v0.4s, v17.s[0]
	fmla	v27.4s, v15.4s, v17.s[0]
	ldp	q29, q12, [x16, #384]
	fmla	v12.4s, v0.4s, v2.s[0]
	fmla	v29.4s, v15.4s, v2.s[0]
	ldp	q25, q30, [x16, #448]
	fmla	v30.4s, v0.4s, v1.s[0]
	fmla	v25.4s, v15.4s, v1.s[0]
	fmla	v22.4s, v6.4s, v24.s[1]
	fmla	v23.4s, v3.4s, v24.s[1]
	fmla	v31.4s, v6.4s, v21.s[1]
	fmla	v13.4s, v3.4s, v21.s[1]
	fmla	v26.4s, v6.4s, v20.s[1]
	fmla	v8.4s, v3.4s, v20.s[1]
	fmla	v28.4s, v6.4s, v19.s[1]
	fmla	v11.4s, v3.4s, v19.s[1]
	fmla	v9.4s, v6.4s, v18.s[1]
	fmla	v14.4s, v3.4s, v18.s[1]
	fmla	v27.4s, v6.4s, v17.s[1]
	fmla	v10.4s, v3.4s, v17.s[1]
	fmla	v29.4s, v6.4s, v2.s[1]
	fmla	v23.4s, v7.4s, v24.s[2]
	fmla	v22.4s, v4.4s, v24.s[2]
	fmla	v13.4s, v7.4s, v21.s[2]
	fmla	v22.4s, v16.4s, v24.s[3]
	fmla	v23.4s, v5.4s, v24.s[3]
	stp	q22, q23, [x16]
	fmla	v31.4s, v4.4s, v21.s[2]
	fmla	v31.4s, v16.4s, v21.s[3]
	fmla	v13.4s, v5.4s, v21.s[3]
	stp	q31, q13, [x16, #64]
	fmla	v8.4s, v7.4s, v20.s[2]
	fmla	v26.4s, v4.4s, v20.s[2]
	fmla	v11.4s, v7.4s, v19.s[2]
	fmla	v28.4s, v4.4s, v19.s[2]
	fmla	v26.4s, v16.4s, v20.s[3]
	fmla	v8.4s, v5.4s, v20.s[3]
	stp	q26, q8, [x16, #128]
	fmla	v14.4s, v7.4s, v18.s[2]
	fmla	v28.4s, v16.4s, v19.s[3]
	fmla	v11.4s, v5.4s, v19.s[3]
	stp	q28, q11, [x16, #192]
	fmla	v9.4s, v4.4s, v18.s[2]
	fmla	v9.4s, v16.4s, v18.s[3]
	fmla	v14.4s, v5.4s, v18.s[3]
	stp	q9, q14, [x16, #256]
	fmla	v12.4s, v3.4s, v2.s[1]
	fmla	v10.4s, v7.4s, v17.s[2]
	fmla	v27.4s, v4.4s, v17.s[2]
	fmla	v12.4s, v7.4s, v2.s[2]
	fmla	v27.4s, v16.4s, v17.s[3]
	fmla	v10.4s, v5.4s, v17.s[3]
	stp	q27, q10, [x16, #320]
	fmla	v29.4s, v4.4s, v2.s[2]
	fmla	v29.4s, v16.4s, v2.s[3]
	fmla	v12.4s, v5.4s, v2.s[3]
	stp	q29, q12, [x16, #384]
	fmla	v25.4s, v6.4s, v1.s[1]
	fmla	v30.4s, v3.4s, v1.s[1]
